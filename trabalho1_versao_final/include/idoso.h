...
* inputs: ponteiro para o idoso e lista de idosos
* output: nenhum
* pre-condicao: idoso existe
* pos-condicao: aspecto falecimento do idoso setado como 1 e removido da lista de idosos
*/
void Idoso_faleceu(Lista_idoso* lista_idoso, Idoso* idoso );
