...
* inputs: diretorio dos arquivos dos dados, uma lista de idosos, uma lista de cuidadores, e o numero de leituras
* output: nenhum
...
int main(int argc, char * argv[]) {
    ...
    char diretorio_entradas[100],
    diretorio_saidas[100],
    diretorio_apoio_txt[200],
    diretorio_cuidadores_txt[200];

    //cria o diretorio onde estao os arquivos de teste
	snprintf( diretorio_entradas, sizeof( diretorio_entradas ), "%sEntradas", argv[1]);
    snprintf( diretorio_saidas, sizeof(diretorio_entradas),"%sSaidas", argv[1]);
    snprintf( diretorio_apoio_txt, sizeof(diretorio_apoio_txt), "%s/apoio.txt", diretorio_entradas);
    snprintf( diretorio_cuidadores_txt,sizeof(diretorio_cuidadores_txt), "%s/cuidadores.txt", diretorio_entradas);
...
void Le_dados_sensores( char* diretorio_arquivos ,Lista_idoso* lista_de_idosos, Lista_cuidador* lista_de_cuidadores ,int num_leituras ) {
    ...
    for( i = 0; i < num_idosos; i++ ) {
        ...
        snprintf( diretorio_arquivo_idoso, sizeof(diretorio_arquivo_idoso), "%sEntradas/%s.txt",diretorio_arquivos, nome_idoso);
        ...
        snprintf( diretorio_arquivo_idoso, sizeof(diretorio_arquivo_idoso), "%sSaidas/%s-saida.txt",diretorio_arquivos, nome_idoso);
        printf("%s\n", diretorio_arquivo_idoso);
    ...
    for( i = 0; i < num_cuidadores; i++ ) {
        ...
        snprintf( diretorio_arquivo_cuidadores, sizeof(diretorio_arquivo_cuidadores), "%sEntradas/%s.txt",diretorio_arquivos, nome_cuidador);
    ...
    for( n = 0; n < num_leituras; n++ ) {
        ...
        for( i = 0; i < num_cuidadores; i++ ) {
            ...
            printf("%s:\n", Cuidador_retorna_nome( cuidador_aux ));
            printf("lat: %d\nlon: %d\n\n\n", lat, lon );
        ...
        if( flag == 1 ) {
            ...
            for( i = 0; i < num_idosos; i++ ) {
                ...
                printf("Idoso: %s\nTemp: %f\n\n", Idoso_retorna_nome(idoso_aux), Idoso_temperatura_atual(idoso_aux));
